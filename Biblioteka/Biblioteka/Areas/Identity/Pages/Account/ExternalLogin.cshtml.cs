...
namespace Biblioteka.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{Name} zalogowany z {LoginProvider} dostawca.", info.Principal.Identity.Name, info.LoginProvider);
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        _logger.LogInformation("Użytkownik utworzył konto za pomocą dostawcy {Name}.", info.LoginProvider);
                        return LocalRedirect(returnUrl);
                    }
                }
