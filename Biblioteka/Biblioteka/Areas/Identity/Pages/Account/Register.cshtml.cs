...
namespace Biblioteka.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "Hasła nie są indentyczne.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Uzytkownik stworzył nowe konto.");
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Potwierdź swój email.",
                        $"Potwierdź swoje konto przez < a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>klikając tutaj</a>.");
